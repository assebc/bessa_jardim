...
public class Corta_Sebes extends Work{
    ...
    public Corta_Sebes(Integer id, Integer id_cliente, List<Integer> id_func, Double hours, Double price) {
        super(id, id_cliente, id_func, hours, price);
    }

    public Corta_Sebes(Integer id, Integer id_cliente, Double hours, Double price) {
        super(id, id_cliente, hours, price);
    }

    public Corta_Sebes(Integer id, Integer id_cliente, Integer id_func, Double hours, Double price) {
        super(id, id_cliente, id_func, hours, price);
    }
