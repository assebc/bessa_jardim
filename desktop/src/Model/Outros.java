...
public class Outros extends Work {
    ...
    public Outros(Integer id, Integer id_cliente, List<Integer> id_func, Double hours, Double price) {
        super(id, id_cliente, id_func, hours, price);
    }

    public Outros(Integer id, Integer id_cliente, Double hours, Double price) {
        super(id, id_cliente, hours, price);
    }

    public Outros(Integer id, Integer id_cliente, Integer id_func, Double hours, Double price) {
        super(id, id_cliente, id_func, hours, price);
    }
