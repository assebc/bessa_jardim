...
public class Corta_Relva extends Work{

    // Constructors

    public Corta_Relva(Integer id, Integer id_cliente, List<Integer> id_func, Double hours, Double price) {
        super(id, id_cliente, id_func, hours, price);
    }

    public Corta_Relva(Integer id, Integer id_cliente, Integer id_func, Double hours, Double price) {
        super(id, id_cliente, id_func, hours, price);
    }

    public Corta_Relva(Integer id, Integer id_cliente, Double hours, Double price) {
